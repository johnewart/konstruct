...
import { runAgentLoop, type RunProgressStore } from './agent/runLoop';
...
// In-memory progress store for this worker
...
// WebSocket connection to server for streaming progress (reconnect on close)
